...
fig, (ax1, ax2) = plt.subplots(2,figsize=(4.5,7))
...
ax1.legend()
ax1.set_title('Maximally Entangled Sequence')
...
ax2.hist(gaussian,bins=np.arange(Min, Max, (Max-Min)/500),align='mid',color='forestgreen',label=''r'$|\mathbb{H}_N$>')
ax2.set_xlim(Min,Max)
ax2.set_ylim(0,30)
ax2.set_yticks([0,5,10,15,20,25,30])
ax2.legend()
ax2.set_title('Haar random state')
