...
CHECKS = [
    ...
    ('reviews/two_cut_symbolic_audit.py', 'reviews/two_cut_symbolic_audit.json'),
...
def main():
    ...
    report = dict(status='passed' if passed else 'failed', python=platform.python_version(),
                  ...
                  scope='New checkpoint-08 deterministic calculations only. No previous state-sampling campaign is rerun.')
