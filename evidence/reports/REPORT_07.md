...
reviews/GENERAL_GATE_REVIEW.md. The square-LUE and second-order fluctuation
...
illustration only if it passed. PROTOCOL.md records its scope and stopping rule.
...
The d=32 results are also retained in results/pilot_summary.json. Both cohorts
